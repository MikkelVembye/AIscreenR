...
```{r}
# Loading included references and excluded studies
...
# Filtering the data so that studies having "meta-anaysis" in the title are excluded.
...
# These studies without any abstract should be saved in another dataset (when doing the full screening) 
# so they can be screened by human coders (or just saying that they go directly to the 2nd stage screening)

```

```{r}
###############################
# Loading the created prompts #
###############################
...
#> Progress: ──────────────────────────────────────────────────────────────────────────────────────────── 100%* Be aware that using gpt-4 models cost at least 10 times more than gpt-3.5 models.
...
The results from the screening can be accessed in two ways:
