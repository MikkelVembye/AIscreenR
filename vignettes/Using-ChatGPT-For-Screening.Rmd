...
# Check why FFT_data and FFT_dat differs 
FFT_data <- 
...
app_obj <- 
  approximate_price_gpt(
    data = FFT_dat, # Tutorial data embedded in the package
    prompt = prompt, 
