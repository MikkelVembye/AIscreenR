...
sum_dat_gpt4 <- 
  result_object$answer_data_sum |> 
  filter(stringr::str_detect(model, "4"))
...
#>  9 9434093          0       9 Enhancing… "New an…        1 "Eval… gpt-4 "Evalua…
#> 10 9431505          0      10 EEG spect… "Sponta…        1 "Eval… gpt-4 "Evalua…
#>    top_p incl_p final_decision_gpt final_decision_gpt_num  reps n_mis_answers
#>    <dbl>  <dbl> <chr>                               <dbl> <int>         <int>
#>  1     1      0 Exclude                                 0     1             0
#>  2     1      0 Exclude                                 0     1             0
