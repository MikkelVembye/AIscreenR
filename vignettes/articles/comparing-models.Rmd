...
# This code is adapted from your Quarto file to process the saved .rds files.
# NOTE: You must ensure the .rds files are in this path or adjust the path accordingly.
setwd("C:/Users/B375477/Desktop/test_ai")
...
for (i in 1:length(models)) {
    ...
    file_rep1 <- if (model == "gpt-4.1") {
      paste0("result_obj_", model, "_rep1_newprompt.rds")
    } else {
      paste0("result_obj_", model, "_rep1.rds")
    }
    
    file_rep10 <- if (model == "gpt-4.1") {
      paste0("result_obj_", model, "_rep10_newprompt.rds")
    } else {
